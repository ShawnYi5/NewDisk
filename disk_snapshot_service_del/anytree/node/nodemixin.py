...
class NodeMixin(object):
    ...
    u"""
    The :any:`NodeMixin` class extends any Python class to a storage_tree node.

    The only storage_tree relevant information is the `parent` attribute.
    ...
    def children(self):
        ...
        Modifying the children attribute modifies the storage_tree.
        ...
        **Detach**
        ...
        Node `c` is removed from the storage_tree.
        In case of an existing reference, the node `c` does not vanish and is the root of its own storage_tree.
