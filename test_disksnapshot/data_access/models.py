...
class CreatedIdents(Base):
    __tablename__ = 'created_idents'
    ...
    id = sqlalchemy.Column(sqlalchemy.BigInteger, primary_key=True, autoincrement=True, nullable=False)
    created_ident = sqlalchemy.Column(sqlalchemy.String(32), nullable=False)
    safe_status = sqlalchemy.Column(sqlalchemy.String(32), nullable=True, default='ns')
    open_status = sqlalchemy.Column(sqlalchemy.String(32), nullable=False, default='nop')
    destroy_status = sqlalchemy.Column(sqlalchemy.String(32), nullable=False, default='nd')
